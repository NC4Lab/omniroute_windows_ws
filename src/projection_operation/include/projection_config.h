...
std::array<std::array<std::array<std::array<int, 3>, 3>, 3>, 4> out_PROJ_W0LL_IMAGE_CFG_4D_VEC =
    {{// Projector 0: West Projector (Facing East)
      {{
          ...
          {{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Middle
          {{{2, 2, 2}, {2, 0, 3}, {3, 3, 3}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Bottom
          {{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}}  // {Calibration Mode: Left, Center, Right}, {...}, {...}
      }},
      ...
      {{
          // Chamber Row: Top, Column: Left, Center, Right
          {{{0, 0, 0}, {2, 2, 2}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Middle
          {{{0, 0, 0}, {3, 0, 0}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Bottom
          {{{0, 0, 0}, {3, 3, 3}, {0, 0, 0}}}  // {Calibration Mode: Left, Center, Right}, {...}, {...}
      }},
      ...
      {{
          ...
          {{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Middle
          {{{3, 3, 3}, {0, 0, 0}, {2, 2, 2}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Bottom
          {{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}}  // {Calibration Mode: Left, Center, Right}, {...}, {...}
      }},
      ...
      {{
          ...
          {{{0, 0, 0}, {3, 3, 3}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Middle
          {{{0, 0, 0}, {0, 0, 2}, {0, 0, 0}}}, // {Calibration Mode: Left, Center, Right}, {...}, {...}
                                               // Chamber Row: Bottom
          {{{0, 0, 0}, {2, 2, 2}, {0, 0, 0}}}  // {Calibration Mode: Left, Center, Right}, {...}, {...}
      }}}};
