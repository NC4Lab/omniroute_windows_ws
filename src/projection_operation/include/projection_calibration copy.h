...
// int cpSelectedInd = 0;
// std::vector<float> cpVertSelectedRGB = {0.0f, 1.0f, 0.0f}; // Active control point marker color (green)
// std::vector<float> cpWallSelectedRGB = {1.0f, 0.0f, 0.0f}; // Inactive control point marker color (red)
...
//  * @return 0 if no errors, -1 if error.
//  */
// int drawColoredCircle(float, float, float, std::vector<float>);
